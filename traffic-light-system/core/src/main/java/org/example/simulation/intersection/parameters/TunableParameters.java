...
public class TunableParameters {
  ...
  /**
   * Priority of straight or right lane (left and right turns happen from the same lane!), should be
   * higher than priority of left lane, as in usual those lanes are more frequently used.
   */
