...
public class TrafficLightPhasesHolder {
  ...
  private static final Set<TrafficLightPhase> TRAFFIC_LIGHT_PHASES =
      Set.of(
          createPhase(
              Map.of(
          ...
          createPhase(
              Map.of(
                  ...
                  new LaneIdentifier(Direction.NORTH, LaneType.STRAIGHT_OR_RIGHT),
                      CONDITIONAL_RIGHT,
                  new LaneIdentifier(Direction.SOUTH, LaneType.STRAIGHT_OR_RIGHT),
                      CONDITIONAL_RIGHT)),
          createPhase(
              Map.of(
                  ...
                  new LaneIdentifier(Direction.EAST, LaneType.STRAIGHT_OR_RIGHT),
                      CONDITIONAL_RIGHT)),
          createPhase(
              Map.of(
                  new LaneIdentifier(Direction.NORTH, LaneType.LEFT), REGULAR,
          ...
          createPhase(
              Map.of(
                  ...
                  new LaneIdentifier(Direction.SOUTH, LaneType.STRAIGHT_OR_RIGHT),
                      CONDITIONAL_RIGHT,
                  new LaneIdentifier(Direction.WEST, LaneType.STRAIGHT_OR_RIGHT),
                      CONDITIONAL_RIGHT)),
          createPhase(
              Map.of(
                  new LaneIdentifier(Direction.NORTH, LaneType.STRAIGHT_OR_RIGHT), REGULAR,
