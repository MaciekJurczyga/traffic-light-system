...
class LaneTypeUnitTest {
  ...
  void testLeftLanePriority() {
    assertThat(LaneType.LEFT.getPriority()).isEqualTo(TunableParameters.LEFT_LINE_PRIORITY);
  }
  ...
  void testDetermineLaneThrowsOnInvalidTurn() {
    assertThatThrownBy(() -> LaneType.determineLaneType(Direction.NORTH, Direction.NORTH))
