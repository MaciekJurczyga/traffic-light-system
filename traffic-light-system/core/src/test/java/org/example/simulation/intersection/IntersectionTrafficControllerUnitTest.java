...
class IntersectionTrafficControllerUnitTest {
  ...
  void shouldMoveVehicleOnRegularLight() {
    ...
    TrafficLightPhase phase =
        new TrafficLightPhase(Set.of(lane), Map.of(lane, TrafficLightType.REGULAR));
  ...
  void shouldMoveConditionalRightTurner() {
    ...
    TrafficLightPhase phase =
        new TrafficLightPhase(Set.of(lane), Map.of(lane, TrafficLightType.CONDITIONAL_RIGHT));
  ...
  void shouldUpdateWaitingTimeForRedLanes() {
    ...
    TrafficLightPhase greenPhase =
        new TrafficLightPhase(Set.of(greenLane), Map.of(greenLane, TrafficLightType.REGULAR));
